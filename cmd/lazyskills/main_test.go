...
func TestCLIUpdate(t *testing.T) {
	...
	if !strings.Contains(out, "lazyskills update") && !strings.Contains(out, "To upgrade, please download") && !strings.Contains(out, "Please download the release manually from") {
